...
<body>
		...
		<div class="bodyFrame">
			...
			<div>
				<table class="table table-striped" style="height: 400px;">
					...
					<tr>
						<td
							style="width: 20%; background: darkgrey; color: white; border: 1px solid #ccc;"
							class="text-center">작성자명</td>
						<td style="width: 60%; background: darkgrey; color: white;"
							class="text-center">${dto.userName} &nbsp;&nbsp;&nbsp;&nbsp;
						</td>
						<td style="width: 20%; background: darkgrey; color: white;"
							class="text-right">${dto.created} | 조회수 ${dto.hitCount}</td>
					</tr>



					<tr>
						<td style="border: 1px solid #ccc;" class="text-center">제목</td>
					...
					<tr style="height: 370px;">
						<td style="border: 1px solid #ccc;" class="text-center"
							rowspan="2">내용</td>
						<td colspan="2"><img
							src="<%=cp%>/uploads/photo/${dto.imageFilename}"
					...
					<tr>
						<td><c:if test="${sessionScope.member.userId==dto.userId}">
						...
						<td align="right">
							<button type="button" class="btn btn-primary btn-sm bbtn"
								onclick="javascript:location.href='<%=cp%>/photo/list.do?page=${page}';">
								목록으로</button>
						</td>
	...
	<div style="width: 100%;">
		<div
			style="width: 600px; height: 25px; line-height: 25px; margin: 0px auto 0px;">
			<img src="<%=cp%>/res/images/new.gif" alt=""
				style="padding-left: 0px; padding-right: 5px;"> 리플 달기
		</div>

		<form name="replyForm" method="post">
			<table style="width: 600px; margin: 0px auto; border-spacing: 0px;">
				<tr height="50">
					<td width="520" align="left"><textarea rows="5" cols="85"
							class="boxTF" name="content" id="content"
							style="width: 520px; height: 45px;"></textarea></td>
					<td width="80" align="right">
						<button type="button" id="btnSend" onclick="sendReply()"
							class="btn btn-primary btn-sm bbtn"
							style="width: 60px; height: 52px;">등록</button> <input
		...
		<div id="listReply" style="width: 600px; margin: 0px auto 10px;">
			<table
				...
				<tr height='30' bgcolor='#EEEEEE' style='border: 1px solid #DBDBDB;'>
					<td width='50%' style='padding-left: 5px;'>이름</td>
					<td width='50%' align='right' style='padding-right: 5px;'>날짜 |
						삭제</td>
				...
				<c:forEach var="dto" items="${listReply}">
					...
					<tr height='30' bgcolor='#EEEEEE'
						...
						<td width='50%' style='padding-left: 5px;'>${dto.userName}</td>
				...
				<tr height='30'>
					<td colspan='2' align='center'>${pagingReply}</td>
				</tr>
			</table>
